...
graficasTransito<- function(lista, ruta, modalidad = "trimestral"){
  ...
  exportarLatex(paste(ruta,"1_04.tex"),g4)
  
  g5 <- graficaLinea(lista$"1_05", inicio = 0)
  exportarLatex(paste(ruta,"1_05.tex"),g5)
  ...
  exportarLatex(paste(ruta,"1_09.tex"),g9)
  
  g10<- graficaLinea(lista$"1_10", inicio = 0)
  exportarLatex(paste(ruta,"1_10.tex"),g10)
  
  
  
  g0 <- graficaLinea(lista$"2_01", inicio = 0)
  exportarLatex(paste(ruta,"2_01.tex"),g0)
  ...
  exportarLatex(paste(ruta,"2_03.tex"),g12)
  
  
  g13 <- graficaCol(lista$"2_04")
  g13 <- etiquetasHorizontales(g13)
  g13 <- rotarEtiX(g13)
  exportarLatex(paste(ruta,"2_04.tex"),g13)
  ...
  g15<- rotarEtiX(g15)
  exportarLatex(paste(ruta,"2_06.tex"),g15)
  
  g16 <- graficaLinea(lista$"2_07", inicio = 0)
  exportarLatex(paste(ruta,"2_07.tex"),g16)
  
  g17 <- graficaCol(lista$"2_08")
  g17 <- etiquetasHorizontales(g17)
  g17<- rotarEtiX(g17)
  exportarLatex(paste(ruta,"2_08.tex"),g17)
  ...
  g29 <- rotarEtiX(g29)
  exportarLatex(paste(ruta,"3_09.tex"),g29)
  
  
  g5<-piramidePoblacional(lista$"3_10", ruta = paste(ruta,"3_10.tex"),
                          porcentual=F,preambulo = F)
  
  
  g32 <- graficaLinea(lista$"3_11", inicio = 0)
  exportarLatex(paste(ruta,"3_11.tex"),g32)
  
  
  g33 <- graficaCol(lista$"3_12")
  g33 <- etiquetasVerticales(g33)
  g33 <- rotarEtiX(g33)
  exportarLatex(paste(ruta,"3_12.tex"),g33)
  ...
  g35 <- rotarEtiX(g35)
  exportarLatex(paste(ruta,"3_14.tex"),g35)
  
  
  g45<-piramidePoblacional(lista$"3_15", ruta = paste(ruta,"3_15.tex"),
                           porcentual=F,preambulo = F)
